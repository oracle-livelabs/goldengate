...
## Task 3: Create a bastion and session to connect using a Database client

Create a bastion and session only if your OCI GoldenGate deployment and MySQL Heatwave system are **not** located in the same region. If they're in the same Home region, go to Task 4.
...
## Task 4: Using CloudShell to connect to the private network
...
## Task 5: Load data into the MySQL DB System
...
## Task 6: Create an OCI PostgreSQL System
