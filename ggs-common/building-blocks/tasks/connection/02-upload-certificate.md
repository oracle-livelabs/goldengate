...
1.  In the Oracle GoldenGate Marketplace Service Manager navigation menu, select **Certificate Management**.

2.  On the Certificate Management page, click **Add CA Certificate** (plus icon).
