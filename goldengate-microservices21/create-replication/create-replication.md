...
In the previous lab you got acquainted with the various components that consitute the lab environment: the Oracle database, the Apache Kafka setup and the GoldenGate console.  We'll now use the various services of the GoldenGate environment to configure the different steps in the replication process.

![Lab Architecture diagrap, showing source, GG setup and Target kafka](./../discover/images/gg21c-lab-archi.png " ")
...
- To create a new Credential, hit the **+** icon
    ...
    ![Addncredentials screen](./images/ora-create-cred.png " ")
...
- Click on the **+** sign of the **Replicats** section
...
- First you'll see the yellow excamation mark icon.

![waiting icon](./images/rep-cre1.png " ")

- After a few seconds you'll see a green icon apear:
