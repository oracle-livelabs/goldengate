...
* Learn to create and assign connections to an OCI GoldenGate deployment
* Add Extracts and Replicats to create a two-way replication between two databases
* Monitor performance
