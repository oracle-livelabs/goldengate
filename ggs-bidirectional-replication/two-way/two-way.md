...
7. Click **Create and Run**. The EXTB Extract process appears after a few moments.
...
6. On the Parameter File page, in the text area, replace **MAP \*.\*, TARGET \*.\*;** with the following:
...
7. Click **Create and Run**. The new Replicat appears after a few moments. 
