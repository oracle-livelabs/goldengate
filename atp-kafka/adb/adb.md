...
This lab walks you through the steps to create the required resources you'll use for Oracle Cloud Infrastructure (OCI) GoldenGate. We'll show you how to create a VCN and subnet, provision an Autonomous Transaction Processing instance, and load data into the database.
...
## Task 2: Add an Ingress Rule for the Bootstrap server

1.  Select the public VCN to view its details.

2.  On the public VCN subnet details page, under Security Lists, click the **Default Security List**.

3.  On the Default Security List details page, under Ingress Rules, click **Add Ingress Rule**.

4.  In the Add Ingress Rules panel, for **Source CIDR**, enter `0.0.0.0/0`.

5.  For **Destination Port Range**, enter `9092`.

6.  (Optional) For **Description**, enter `Kafka access`.
