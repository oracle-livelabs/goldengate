...
This lab walks you through the steps to create the required resources you'll use for Oracle Cloud Infrastructure (OCI) GoldenGate. We'll show you how to create a VCN and subnet, provision OCI MySQL Database and autonomous database instances, and load data into the databases.
...
-  Provision, connect, and load data into an OCI MySQL Database instance
-  Provision, connect to an Autonomous Data Warehouse (ADW) instance
...
## Task 2: Create an OCI MySQL Database instance

## Task 3: Create an ADW instance
